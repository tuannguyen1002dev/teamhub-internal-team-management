...
export default function DashboardLayout({ children, }: { children: React.ReactNode }) {
  ...
  return (
    <div className="h-screen w-[100%] flex flex-row gap-6 p-6 bg-amber-500 transition-all duration-500 ease-in-out">
      <div className={`h-full rounded-3xl transition-all duration-500 ease-in-out bg-black/90 ${sideBarState ? 'w-[10%]' : 'w-[17%]'}`}>

      </div>
      <div className="w-[83%] h-full rounded-3xl transition-all duration-500 ease-in-out bg-black/90">
